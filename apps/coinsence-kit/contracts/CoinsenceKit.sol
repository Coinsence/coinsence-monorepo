...
contract CoinsenceKit is KitBase {
    ...
    function newInstance(address root) public {
    ...
    function createCSApps (address root, Kernel dao) internal {
        Space space;
        Coin coin;
        ...
        initializeCSApps(space, coin, root);
