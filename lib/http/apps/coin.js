...
app.post(`/mint`, (req, res) => {
    ...
    res.locals.coinsence.Coin.functions.mintCoin(recipient, ethers.utils.parseEther(amount.toString()), { gasLimit: 5000000 }).then(transaction => {
...
app.post(`/transfer`, (req, res) => {
    ...
    console.log("sending to and type")
    console.log(to)
    console.log(typeof to)
    console.log("coin address and type")
    console.log(res.locals.coinsence.Coin.address)
    console.log(typeof res.locals.coinsence.Coin.address)

    res.locals.coinsence.Coin.functions.transfer(to, ethers.utils.parseEther(amount.toString()), { gasLimit: 5000000 }).then(transaction => {
